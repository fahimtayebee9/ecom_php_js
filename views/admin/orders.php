                                        ...
                                        <div class="col-md-12">
                                            <div class="table-box">
                                                ...
                                                <form action="../../controller/admin/CustomerController.php" method="post" enctype="multipart/form-data" class="needs-validation">
                                                    <div class="row mb-3">
                                                        <div class="col">
                                                            <input type="text" class="form-control" disabled placeholder="Full Name" value="<?=$item->name?>">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col">
                                                            <select class="form-control" aria-placeholder="user_type" name="user_type">
                                                                ...
                                                                <option value="0" <?php if($item->user_type == 0){ echo "selected"; }?> >Premium</option>
                                                                <option value="1" <?php if($item->user_type == 1){ echo "selected"; }?> >Gold</option>
                                                                <option value="2" <?php if($item->user_type == 2){ echo "selected"; }?> >Standard</option>
                                                            </select>
                                                        </div>
                                                        <div class="col">
